...
export default function Chat(){
    ...
    {isLoggedIn(localStorage.getItem("token"))?<div className="flex flex-col h-screen max-w-4xl mx-auto bg-white border border-gray-200 rounded-lg shadow-lg mt-25">

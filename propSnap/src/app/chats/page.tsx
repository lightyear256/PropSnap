            ...
            <div className="min-h-screen bg-gray-50 p-2 sm:p-4 pt-16 sm:pt-20">
                <div className="max-w-6xl mx-auto">
                    <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 text-center">
                        ...
                        <p className="text-gray-600 mt-4 text-sm sm:text-base">Loading chats...</p>
                    </div>
                </div>
            </div>
        );
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="bg-white rounded-lg shadow-sm p-6 sm:p-8 text-center">
                        <div className="text-red-500 mb-4">
                            <MessageCircle className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-2" />
                        </div>
                        <h3 className="text-base sm:text-lg font-medium text-gray-900 mb-2">Error Loading Chats</h3>
                        <p className="text-red-600 mb-4 text-sm sm:text-base">{error}</p>
                        <Button onClick={fetchChats} variant="primary" className="text-sm sm:text-base">
                            Try Again
                        </Button>
                    </div>
                </div>
    ...
    return (
        <>
            {isLoggedIn(localStorage.getItem("token")) ? 
                <div className="min-h-screen bg-gray-50 pt-16 sm:pt-20 mt-25">
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                                    <div className="flex-1">
                                        <h1 className="text-xl sm:text-2xl font-bold text-gray-900 flex items-center">
                                            <MessageCircle className="w-5 h-5 sm:w-7 sm:h-7 mr-2 sm:mr-3 text-teal-600 flex-shrink-0" />
                                            <span className="truncate">My Chats</span>
                                        </h1>
                                        <p className="text-gray-600 mt-1 text-sm sm:text-base">
                                            Manage conversations with potential buyers and tenants
                                        </p>
                                    </div>
                        ...
                        <div className="mb-4 sm:mb-6">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent text-sm sm:text-base"
                                />
                            </div>
                        </div>
                                    ...
                                    >
                                        <div className="p-3 sm:p-4">
                                            <div className="flex items-start justify-between">
                                                <div className="flex items-start space-x-2 sm:space-x-3 flex-1 min-w-0">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <div className="flex items-center justify-between mb-1">
                                                            ...
                                                            <div className="flex items-center text-xs sm:text-sm text-gray-500 ml-2 flex-shrink-0">
                                                                <Clock className="w-3 h-3 mr-1" />
                                                                <span className="hidden sm:inline">
                                                                    {formatTimestamp(chat.updatedAt)}
                                                                </span>
                                                                <span className="sm:hidden">
                                                                    {formatTimestamp(chat.updatedAt).replace(' ago', '')}
                                                                </span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="flex flex-col sm:flex-row sm:items-center text-xs sm:text-sm text-gray-500 mb-2 gap-1 sm:gap-0">
                                                            <div className="flex items-center">
                                                                <MapPin className="w-3 h-3 mr-1 flex-shrink-0" />
                                                                <span className="truncate">{chat.property.city.name}, {chat.property.city.state}</span>
                                                            </div>
                                                            <span className="hidden sm:inline mx-2">•</span>
                                                            <span className="font-medium text-teal-600 ml-4 sm:ml-0">
                                                ...
                                                <div className="flex items-center space-x-2 ml-2 sm:ml-3">
                                        ...
                                        <div className="px-3 sm:px-4 pb-3 sm:pb-4">
                                            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                                                ...
                                                <Button
                                                    variant="secondary"
                                                    className="text-xs sm:text-sm py-2 px-4 sm:flex-none"
                                                    onClick={(e) => {
                                                        e.stopPropagation();
